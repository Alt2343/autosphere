...
class Category(models.Model):
    ...
    parent = models.ForeignKey('self', on_delete=models.CASCADE, null=True, blank=True, verbose_name='Категория', related_name='sub_categories')
...
class Product(models.Model):
    ...
    def __repr__(self):
        return f'Товар: pk={self.pk}, title={self.title} price={self.title}'
